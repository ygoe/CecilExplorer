...
#pragma warning restore 1720
		...
		/// <returns>true if <paramref name="type"/> is a list; otherwise, false.</returns>
		...
		/// </summary>
		/// <param name="type">The type to check.</param>
		/// <returns>true if <paramref name="type"/> is a dictionary; otherwise, false.</returns>
	...
	public interface ISettingsStore : INotifyPropertyChanged, IDisposable
	{
		...
		/// </summary>
		/// <returns>An array that contains all setting keys.</returns>
		string[] GetKeys();
		...
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise false.</returns>
		...
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise the
		///   <paramref name="fallbackValue"/>.</returns>
		...
		/// </summary>
		/// <param name="key">The setting key.</param>
		/// <returns>The array of values stored under the <paramref name="key"/>, if it exists;
		...
		/// </summary>
		/// <param name="key">The setting key.</param>
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise 0.</returns>
		...
		/// </summary>
		/// <param name="key">The setting key.</param>
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise NaN.</returns>
		...
		/// </summary>
		/// <param name="key">The setting key.</param>
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise an
		...
		/// </summary>
		/// <param name="key">The setting key.</param>
		/// <returns>The value stored under the <paramref name="key"/>, if it exists; otherwise
		///   <see cref="DateTime.MinValue"/>.</returns>
		...
		/// <param name="key">The setting key.</param>
		/// <returns>The list wrapper for an array-typed key.</returns>
		...
		/// <param name="key">The setting key.</param>
		/// <returns>The dictionary wrapper for a NameValueCollection-typed key.</returns>
	...
	public class SettingsStoreBoundDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		///   returns false if key was not found in the original dictionary.</returns>
		...
		/// <returns>true if the object that implements dictionary contains an element with the
